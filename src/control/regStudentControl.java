    ...
    public Boolean regStudent(regStudentControl stud, JTable studentclasses, JCheckBox box) {
        ...
        if (!stud.getFName().trim().isEmpty() && df.getRowCount() != 0) {
            ...
            try {
                ...
                rsx.first();
                String invoiceIdnow = rsx.getString("id");               
                setInvoiceid(invoiceIdnow + "");
